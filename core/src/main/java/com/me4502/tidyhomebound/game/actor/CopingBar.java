...
public class CopingBar extends Actor {
    ...
    public CopingBar(AssetManager assetManager, GameState gameState, Vector2 position, float width, float height) {
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        GlyphLayout layout = new GlyphLayout(font, "Coping");
